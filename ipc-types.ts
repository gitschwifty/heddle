...
export const IpcRequestSchema = Type.Union([
  Type.Object({ type: Type.Literal("init"), id: Type.String(), protocol_version: Type.Optional(Type.String()), config: InitConfigSchema }),
...
export const WorkerEventSchema = Type.Union([
  ...
  Type.Object({ event: Type.Literal("usage"), prompt_tokens: Type.Number(), completion_tokens: Type.Number(), total_tokens: Type.Number() }),
...
export const IpcResponseSchema = Type.Union([
  Type.Object({ type: Type.Literal("init_ok"), id: Type.String(), session_id: Type.String(), protocol_version: Type.String(), error: Type.Optional(Type.String()) }),
  ...
  Type.Object({
    ...
    usage: Type.Optional(Type.Object({ prompt_tokens: Type.Number(), completion_tokens: Type.Number(), total_tokens: Type.Number() })),
    iterations: Type.Number(),
    error: Type.Optional(Type.String()),
  }),
  Type.Object({ type: Type.Literal("status_ok"), id: Type.String(), model: Type.String(), messages_count: Type.Number(), session_id: Type.String(), active: Type.Boolean() }),
